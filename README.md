...
- 热点名称: `<your-hotspot-ssid>`
- 热点密码: `<your-hotspot-password>`
...
```cpp
constexpr char kWifiSsid[] = "<your-ssid>";        // WiFi 名称
constexpr char kWifiPassword[] = "<your-password>"; // WiFi 密码
constexpr char kServerHost[] = "<your-server-ip>";  // PC 热点网关 IP
